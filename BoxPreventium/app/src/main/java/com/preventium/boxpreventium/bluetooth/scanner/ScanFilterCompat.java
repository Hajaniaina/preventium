...
public class ScanFilterCompat implements Parcelable {
    ...
    ScanFilter toApi21() {
        ...
        if (mDeviceName != null) builder.setDeviceName(mDeviceName);
        if (mServiceUuid != null) builder.setServiceUuid(mServiceUuid, mServiceUuidMask);
        if (mDeviceAddress != null) builder.setDeviceAddress(mDeviceAddress);
        if (mServiceDataUuid != null) builder.setServiceData(mServiceDataUuid, mServiceData, mServiceDataMask);
        if (mManufacturerId < 0) builder.setManufacturerData(mManufacturerId, mManufacturerData, mManufacturerDataMask);
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        if (mDeviceName != null) dest.writeString(mDeviceName);
        dest.writeInt(mDeviceAddress == null ? 0 : 1);
        if (mDeviceAddress != null) dest.writeString(mDeviceAddress);
    ...
    public static final Creator<ScanFilterCompat> CREATOR = new Creator<ScanFilterCompat>() {
        ...
        @Override
        public ScanFilterCompat[] newArray(int size) { return new ScanFilterCompat[size]; }

        @Override
        public ScanFilterCompat createFromParcel(Parcel in) {
            Builder builder = new Builder();
            if (in.readInt() == 1) builder.setDeviceName(in.readString());
            if (in.readInt() == 1) builder.setDeviceAddress(in.readString());
            if (in.readInt() == 1) {
     ...
     */
    @Nullable public String getDeviceName() { return mDeviceName; }

    /**
     * Returns the filter set on the service uuid.
     */
    @Nullable public ParcelUuid getServiceUuid() { return mServiceUuid; }

    @Nullable public ParcelUuid getServiceUuidMask() { return mServiceUuidMask; }

    @Nullable public String getDeviceAddress() { return mDeviceAddress; }

    @Nullable public byte[] getServiceData() { return mServiceData; }

    @Nullable public byte[] getServiceDataMask() { return mServiceDataMask; }

    @Nullable public ParcelUuid getServiceDataUuid() { return mServiceDataUuid; }
    ...
    @Nullable public byte[] getManufacturerData() { return mManufacturerData; }

    @Nullable
    public byte[] getManufacturerDataMask() { return mManufacturerDataMask; }
