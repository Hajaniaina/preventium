...
public class ScanSettingsCompat implements Parcelable {
     ...
     */
    public long getReportDelayMillis() { return mReportDelayMillis; }
    ...
    public static final Parcelable.Creator<ScanSettingsCompat> CREATOR = new Parcelable.Creator<ScanSettingsCompat>() {
        @Override
        public ScanSettingsCompat[] newArray(int size) { return new ScanSettingsCompat[size]; }
        @Override
        public ScanSettingsCompat createFromParcel(Parcel in) { return new ScanSettingsCompat(in); }
    };
