...
public class ThreadSuperClass extends Thread{
    ...
    private static final String TAG = "ThreadSuperClass";
    ...
    public ThreadSuperClass(NotifyListener notify) {
        super(TAG);
        setNotify(notify);
    }
    ...
    public boolean isPausing() {
        return (isThreadRunning.get() && isThreadPausing.get());
    }
