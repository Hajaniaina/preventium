...
import com.ikalogic.franck.permissions.listener.multi.EmptyMultiplePermissionsListener;
...
final class PermInstance {
  ...
  PermInstance(Context context, AndroidPermissionService androidPermissionService,
  ...
  private void startTransparentActivityIfNeeded() {
    Intent intent = intentProvider.get(context, PermActivity.class);
